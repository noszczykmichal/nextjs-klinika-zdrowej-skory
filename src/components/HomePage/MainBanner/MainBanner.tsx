  ...
  return (
    <div className="h-[625px] sm:flex sm:h-[70vh] sm:max-h-[500px] rounded-[var(--big-border-radius)] mt-[20px] sm:mt-0">
      <div className="relative h-[40%] sm:w-[50%] sm:h-full flex items-center justify-center">
        ...
        />
        <h1 className="absolute w-full text-center font-extralight text-[30px] whitespace-wrap xxs:text-(length:--font-big-banner) sm:text-(length:--font-small-banner) lg:text-(length:--font--medium-banner) sm:whitespace-normal">
          {headerText}
        </h1>
      </div>
